...
class StylesXform extends BaseXform {
  ...
  render(xmlStream, model) {
    ...
    // This is very fast solution and should be rewrite, fixes empty numfmt in dxf rendering
    model.dxfs.forEach((dxf, dxfIndex) => {
      if (dxf.numFmt) {
        const formatCode = dxf.numFmt;
        ...
        index = NUMFMT_BASE + this.model.numFmts.length;

        dxf.numFmt = {id: index, formatCode};
        this.model.numFmts.push(undefined);
      }
    });
