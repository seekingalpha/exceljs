...
var StylesXform = /*#__PURE__*/function (_BaseXform) {
  ...
  _createClass(StylesXform, [{
    ...
    value: function render(xmlStream, model) {
      ...
      StylesXform.STATIC_XFORMS.cellStyles.render(xmlStream); // This is very fast solution and should be rewrite, fixes empty numfmt in dxf rendering

      model.dxfs.forEach(function (dxf, dxfIndex) {
        if (dxf.numFmt) {
          var formatCode = dxf.numFmt;
          ...
          index = NUMFMT_BASE + _this2.model.numFmts.length;
          dxf.numFmt = {
            id: index,
            formatCode: formatCode
          };

          _this2.model.numFmts.push(undefined);
        }
      });
        ...
        case 'styleSheet':
          {
            ...
            var add = function add(propName, xform) {
              if (xform.model && xform.model.length) {
                _this3.model[propName] = xform.model;
              }
            };
